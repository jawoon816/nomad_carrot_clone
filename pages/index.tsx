      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-2xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          ...
          <div className="relative -mt-10 -mb-5 flex flex-col items-center">
            <span className="text-xl font-medium">Tony Mollly</span>
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="rounded-lg flex justify-center items-center bg-blue-100 aspect-square w-8 font-medium text-xl text-gray-400">
                -
              </button>
              <span>1</span>
              <button className="rounded-lg flex justify-center items-center bg-blue-100 aspect-square w-8 font-medium text-xl text-gray-400">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="bg-blue-500 rounded-lg py-2 px-10 text-white">
              Add to cart
            </div>
          </div>
        </div>
